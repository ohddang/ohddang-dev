...
const Garage = () => {
  ...
  return (
    <div className="min-h-[800px] h-screen flex flex-row bg-mono-gray-100 pt-20">
      <div className="w-full h-full p-10">
        <div className="relative w-full h-full bg-gradient-to-b from-mono-gray-100 to-mono-gray-500 rounded border-4 border-mono-gray-800 ">
